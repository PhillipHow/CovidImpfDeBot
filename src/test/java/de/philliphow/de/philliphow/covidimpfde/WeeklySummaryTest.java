...
public class WeeklySummaryTest {
	...
	private void generateTestVaccinationData() {
		...
		dataRowExample.add(new VaccinationDataRow("2021-04-10 50", "date dosen_differenz_zum_vortag"));
		dataRowExample.add(new VaccinationDataRow("2021-04-11 100", "date dosen_differenz_zum_vortag"));
		dataRowExample.add(new VaccinationDataRow("2021-04-12 200", "date dosen_differenz_zum_vortag"));
		dataRowExample.add(new VaccinationDataRow("2021-04-13 300", "date dosen_differenz_zum_vortag"));
		dataRowExample.add(new VaccinationDataRow("2021-04-14 400", "date dosen_differenz_zum_vortag"));
	}
