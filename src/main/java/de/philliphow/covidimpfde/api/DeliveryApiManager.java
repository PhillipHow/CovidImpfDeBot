 ...
 * pattern. Provides two singleton instances,a production instance for querying
 * the actual data and a debug instance that only queries a local file in the
 * project root directory for testing purposes. See class constants for data
 * source URLs.
 * 
 * @author PhillipHow
 *
...
public class DeliveryApiManager extends AbstractTsvApiWithCache<DeliveryDataRow> {
	...
	public List<DeliveryDataRow> getCurrentData() {
		 ...
		 * accumulated to see the federal deliveries.
		 */
